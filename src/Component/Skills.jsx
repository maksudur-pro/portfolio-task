    ...
    <div className="bg-white px-4 py-4  md:h-[303px] lg:h-[303px] font-Montserrat shadow-lg rounded-lg">
      ...
      <div className="grid grid-cols-2 p-6 lg:p-2 lg:grid-cols-6  gap-y-4 mt-4">
        ...
        <div className="flex gap-1 items-center">
          ...
          <h1 className="text-[#4F4F4F] font-medium">React Query</h1>
        </div>
        <div className="flex gap-1 items-center">
          <div className="rounded-full">
            <img src={gsap} className="w-8 h-8  text-black" alt="" />
          </div>

          <h1 className="text-[#4F4F4F] font-medium">Gsap</h1>
        </div>
        <div className="flex gap-1 items-center">
          <div className="rounded-full">
        ...
        <div className="flex gap-1 items-center">
          <div className="rounded-full">
            <img src={problem_solving} className="w-8 h-8  text-black" alt="" />
          </div>

          <h1 className="text-[#4F4F4F] font-medium">Prob Solv</h1>
        </div>
      </div>
    </div>
  );
